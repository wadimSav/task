                    ...
                    <div class="row mb32">
                        ...
                        <div class="col-lg-3 col-md-4 col-11">
                            ...
                            <label class="custom-file-upload">
                                ...
                                <?= $form->field($model, 'image', ['enableLabel' => false])->fileInput() ?>
                    ...
                    <div class="row mb24">
                        ...
                        <div class="col-lg-3 col-md-4 col-11">
                            <div class="datepicker-wrap input-group date">
                                ...
                                <?= $form->field($model, 'date_of_birth', ['enableLabel' => false])
                            ...
                            <div class="profile-info">
                                ...
                                <?= $form->field($model, 'employment', ['enableLabel' => false])
                                    ->checkboxList([
                                        ...
                                        $answer .= '<input type="checkbox" class="form-check-input" id="employmentCheck'. ++$index .'" value="' . $value . '"> ';
                            ...
                            <div class="profile-info">
                                ...
                                <?= $form->field($model, 'schedule', ['enableLabel' => false])
                                    ->checkboxList([
                                        ...
                                        // ($index == 0) ? $checked = 'checked' : '' ;
                                        $answer = '<div class="form-check d-flex">';
                                        $answer .= '<input type="checkbox" class="form-check-input" id="scheduleCheck'. ++$index .'" value="' . $value . '"> ';
        ...
        <div class="profile-info">
            ...
            <?= $form->field($model_exp, 'until_now_work', ['enableLabel' => false])
                        ->checkboxList([
                            ...
                            $answer = '<input type="checkbox" class="form-check-input" id="untilCheck'. ++$index .'" value="' . $value . '"> ';
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="devide-border"></div>
                    ...
                    <div class="form-group">
                        <?= Html::submitButton('Submit', ['class' => 'btn btn-primary', 'name' => 'resume-button']) ?>
                    </div>
